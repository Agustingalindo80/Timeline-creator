...
import PortfolioHealth from "@/pages/portfolio-health";
...
import OpportunityPipelineReport from "@/pages/reports/opportunity-pipeline";
...
function AppRouter() {
  return (
    <Switch>
      ...
      <Route path="/reports/opportunity-pipeline">{() => <ProtectedRoute requiredModule="module.reports"><OpportunityPipelineReport /></ProtectedRoute>}</Route>
      ...
      <Route path="/business-outcomes">{() => <ProtectedRoute requiredModule="module.business_outcomes"><BusinessOutcomesPage /></ProtectedRoute>}</Route>
