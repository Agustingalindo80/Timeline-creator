...
- **Convert to Project:** `POST /api/opportunities/:id/convert` creates new project at Stage 1, copies tasks/team/allocations/RAID. Gate must be passed/exception first.
